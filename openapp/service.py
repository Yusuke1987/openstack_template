...
service_opts = [
    ...
    cfg.StrOpt('template_listen',
               default="0.0.0.0",
               help='The IP address on which the Template API will listen.'),
    cfg.IntOpt('template_listen_port',
               default=8773,
               help='The port on which the Template API will listen.'),
    cfg.IntOpt('template_workers',
               help='Number of workers for Template API service. The default will '
